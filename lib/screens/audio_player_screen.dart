...
class _AudioPlayerScreenState extends State<AudioPlayerScreen>
                ...
                actions: [
                  ...
                  if ((player.currentEntity ?? widget.entity).typeInt == 3)
                    PopupMenuButton<_AudioMoreAction>(
                      ...
                      itemBuilder: (context) => [
                        _buildPopupItem(
                          _AudioMoreAction.addToPlaylist,
                          'addToPlaylist',
                        ),
                        _buildPopupItem(
                          _AudioMoreAction.properties,
                          'properties',
                        ),

                        if (Platform.isAndroid)
                          _buildPopupItem(
                            _AudioMoreAction.setAsRingtone,
                            'setAsRingtone',
                          ),
                        _buildPopupItem(
                          _AudioMoreAction.setSleepTimer,
                          'setSleepTimer',
                        ),
                        const PopupMenuDivider(),
                        _buildPopupItem(
                          _AudioMoreAction.abSetPointA,
                          'abSetPointA',
                        ),
                        _buildPopupItem(
                          _AudioMoreAction.abSetPointB,
                          'abSetPointB',
                          enabled: _pointA != null && _pointB == null,
                        ),
                        _buildPopupItem(
                          _AudioMoreAction.abClearRepeat,
                          'abClearRepeat',
                          enabled: _pointA != null || _pointB != null,
                        ),
                      ],
  ...
  PopupMenuItem<_AudioMoreAction> _buildPopupItem(
      _AudioMoreAction action,
      String title, {
        bool enabled = true,
      }) {
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            if (_pageController.hasClients) {
                              ...
                              int nextIdx =
                                  currentIdx +
                                      1; // àª…àª¹à«€àª‚ àªªà«àª²àª¸ (+) àª†àªµàª¶à«‡
  ...
  //     );
  //   } catch (e) {
  //     // Printing the error to your console will save you tons of debugging time!

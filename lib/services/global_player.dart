...
class GlobalPlayer extends ChangeNotifier {
  ...
  void _videoListener() {
    ...
    // àª…àª¹à«€àª‚ àªšà«‡àª• àª¥àª¾àª¯ àª›à«‡ àª•à«‡ àªµà«€àª¡àª¿àª¯à«‹ àª²à«‹àª¡ àª¥àª¯à«‹ àª›à«‡ àª…àª¨à«‡ àª¤à«‡àª¨à«€ àªªà«‹àªàª¿àª¶àª¨ àª¤à«‡àª¨àª¾ àª•à«àª² àª¡à«àª¯à«àª°à«‡àª¶àª¨ (Duration) àªœà«‡àªŸàª²à«€ àª¥àªˆ àª—àªˆ àª›à«‡ àª•à«‡ àª¨àª¹à«€àª‚.
    if (videoController != null &&
        videoController!.value.isInitialized &&
        videoController!.value.position >= videoController!.value.duration) {

      // àªµà«€àª¡àª¿àª¯à«‹ àªªà«‚àª°à«‹ àª¥àª¾àª¯ àªàªŸàª²à«‡ àª²àª¿àª¸àª¨àª° àª°àª¿àª®à«‚àªµ àª•àª°à«€ àª¦à«‡àªµàª¾àª®àª¾àª‚ àª†àªµà«‡ àª›à«‡
      videoController!.removeListener(_videoListener);

      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (currentIndex != -1) {
          debugPrint("Video Finished!"); // àª† àª¤àª®à«‡ àªŸà«‡àª¸à«àªŸàª¿àª‚àª— àª®àª¾àªŸà«‡ àª‰àª®à«‡àª°à«€ àª¶àª•à«‹
          playNext(); // àªµà«€àª¡àª¿àª¯à«‹ àªªà«‚àª°à«‹ àª¥àª¤àª¾ àªœ àª†àª—àª¾àª®à«€ àª®à«€àª¡àª¿àª¯àª¾ àªªà«àª²à«‡ àª•àª°à«‡ àª›à«‡
        }
      });
    }
  }
